...
function getImg(id) { var el = document.getElementById(id); return el ? el.src : ""; }
...
function initApp() {
  var gArt = document.getElementById("giving-art-img");
  if (gArt) gArt.src = getImg("img-seventh-tradition");
  ...
  if (modal) {
    modal.addEventListener("click", function(e) { if (e.target === this) closeMapModal(); });
  }
}
